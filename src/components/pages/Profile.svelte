...
<div id="profile" class="fmt-tab container-fluid">
  ...
  >
    <div class="carousel-inner full-height">
      ...
      <div class="carousel-item">
        <div id="energy-data" class="row justify-content-center mb-4">
          <div class="row justify-content-between col-12 col-lg-8 mb-3 mt-3">
            ...
            <div class="card">
              <div class="card-header fmt-bg-dark-green d-flex fmt-center-text">
                ...
                <i
                  ...
                  class="fa fa-light fa-info-circle fmt-font-white-bold"
    ...
    >
      <span
        class="carousel-control-prev-icon fa fa-light fa-chevron-left fmt-carousel-control"
        aria-hidden="true"
      />
    ...
    >
      <span
        class="carousel-control-next-icon fa fa-light fa-chevron-right fmt-carousel-control"
        aria-hidden="true"
      />
