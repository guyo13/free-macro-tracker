...
<div id="add-to-meal-screen" class="fmt-dynamic-screen container-fluid">
  ...
  <div class="row justify-content-center mt-3">
    <div class="d-flex col-12 col-lg-8 justify-content-between mb-1">
      ...
      >
        <button
          action="food"
          class="fa fa-light fa-plus btn fmt-text-btn1 flex-fill fmt-text-color-light-green"
          type="button"
        />
      </div>
      <div
        ...
        style="cursor: pointer;"
      >
        <button class="fa fa-light fa-times btn fmt-text-btn1" type="button" />
      </div>
    </div>
  </div>
  <div class="row justify-content-center">
    ...
    <div
      ...
      class="input-group col-12 col-lg-8 d-none mb-1 mt-1"
    >
      <div class="input-group-prepend fmt-w-inherit">
        <input
