...
<div id="overview" class="fmt-tab container-fluid">
  ...
  <div id="overview-container" class="">
    <div
      ...
      class="row justify-content-center mb-3 mt-3"
    >
      <div id="overview-date-prev" class="col-lg-1 col-2">
        <button
          id="overview-date-prev-day-lg"
          type="button"
          class="fa fa-light fa-chevron-left btn btn-lg fmt-btn-no-focus d-none d-md-block float-left"
        />
        <button
          id="overview-date-prev-day-sm"
          type="button"
          class="fa fa-light fa-chevron-left btn fmt-btn-no-focus d-md-none float-left"
        />
      </div>
      ...
      <div id="overview-date-next" class="col-lg-1 col-2">
        <button
          ...
          type="button"
          class="fa fa-light fa-chevron-right btn btn-lg fmt-btn-no-focus d-none d-md-block float-right"
        />
        <button
          id="overview-date-next-day-sm"
          type="button"
          class="fa fa-light fa-chevron-right btn fmt-btn-no-focus d-md-none float-right"
        />
      </div>
    </div>
    <div id="calories-cont" class="row justify-content-center mb-3 mt-3">
    ...
    <div id="macroes-cont" class="row justify-content-center mb-1 ml-1 mr-1">
