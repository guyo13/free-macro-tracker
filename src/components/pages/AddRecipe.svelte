...
<div id="add-recipe-screen" class="fmt-dynamic-screen container-fluid">
  ...
  <div class="fmt-column full-height">
    <!-- Heading -->
    <div class="row justify-content-center fmt-flex-1 mt-3">
      <div class="d-flex col-12 col-lg-8 justify-content-between mb-1">
        ...
        >
          <button class="fa-light fa-times btn fmt-text-btn1" type="button" />
        </div>
      </div>
    </div>
    <!-- Content -->
      ...
      <div class="col-12 col-lg-8 mb-1">
        <div class="form__group d-flex">
          <textarea
            ...
            required
          />
          <label for="add-recipe-screen-recipe-description" class="form__label"
            >Description</label
          >
        </div>
      </div>
