  ...
  <div id="odin" class="fmt-allfather">
    <div id="overview" class="fmt-tab container-fluid">
      ...
      <div id="overview-container" class="">
        ...
        <div
          id="macroes-cont"
          class="mb-1 row justify-content-center mr-1 ml-1"
        >
        ...
        <div class="carousel-inner full-height">
          ...
          <div class="carousel-item">
            <div id="energy-data" class="row justify-content-center mb-4">
              <div
                class="row justify-content-between col-12 col-lg-8 mt-3 mb-3"
              >
              ...
              <div class="col-12 col-lg-8 mb-1">
                <div class="form__group fmt-macro-form-container">
                  <input
                    ...
                    required
                  />
                  <label for="profile-macro-carb" class="form__label"
                    >Carbs</label
                  >
                  <!-- FIXME: Don't use aria-roledescription to store the previous selection -->
                  <select
        ...
        >
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex" id="add-food-screen-food-serving">
              ...
              />
              <label
                for="add-food-screen-food-serving-input"
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex">
              ...
              />
              <label
                for="add-food-screen-food-carbohydrates"
                class="form__label">Carbohydrates</label
              >
            </div>
          </div>
          <div class="col-12 col-lg-8 mb-1">
        ...
        >
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex" id="edit-food-screen-food-serving">
              ...
              />
              <label
                for="edit-food-screen-food-serving-input"
                class="form__label">Serving</label
              >
            </div>
          </div>
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex">
              ...
              />
              <label
                for="edit-food-screen-food-carbohydrates"
                class="form__label">Carbohydrates</label
              >
            </div>
          </div>
          ...
          >
            ...
            <div
              id="edit-food-screen-food-additional"
        ...
        >
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex fmt-align-start fmt-space-between">
              ...
              <div
                class="fmt-flex-column fmt-align-center fmt-font-color-violet"
              >
                <span>Carbs</span>
              ...
              <div
                class="fmt-flex-column fmt-align-center fmt-font-color-orange"
              >
                <span>Fats</span>
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex" id="view-food-screen-food-serving">
              ...
              />
              <label
                for="view-food-screen-food-serving-input"
                class="form__label">Serving</label
              >
            </div>
          </div>
          ...
          >
            ...
            <div
              id="view-food-screen-food-additional"
              class="col-12 col-lg-8"
            />
          </div>
        </div>
        ...
        >
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div
              ...
              id="add-recipe-screen-recipe-serving"
            >
              <input
                type="number"
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex">
              ...
              />
              <label
                for="add-recipe-screen-recipe-video-url"
                class="form__label">Video Link</label
              >
            </div>
          </div>
          <div class="col-12 col-lg-8 mb-1">
        ...
        >
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex">
              ...
              />
              <label
                for="view-recipe-screen-recipe-video-url"
                class="form__label">Video Link</label
              >
            </div>
          </div>
        ...
        >
          ...
          <div class="col-12 col-lg-8 mb-1">
            <div class="form__group d-flex">
              ...
              />
              <label
                for="edit-recipe-screen-recipe-video-url"
                class="form__label">Video Link</label
              >
            </div>
          </div>
    ...
    <div id="add-to-recipe-screen" class="fmt-dynamic-screen container-fluid">
      <div
        id="add-to-recipe-screen-alerts"
        class="row justify-content-center"
      />
